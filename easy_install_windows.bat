@echo off
echo Instalador simplificado para el Selector de Contexto para LLMs
echo ==========================================================
echo.
...
REM Generar ejecutable con el nuevo script
echo Generando ejecutable con correcciones de importación...
