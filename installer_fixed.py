...
3. Corregir importaciones relativas
4. Generar un ejecutable independiente
"""
...
def fix_imports(project_dir):
    ...
    fix_imports_content = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
'''
    ...
    # Crear el script fix_imports.py si no existe
    fix_imports_script = os.path.join(project_dir, "fix_imports.py")
    if not os.path.exists(fix_imports_script):
        with open(fix_imports_script, 'w', encoding='utf-8') as f:
            f.write(fix_imports_content)
        print_success(f"Script fix_imports.py creado en: {fix_imports_script}")
